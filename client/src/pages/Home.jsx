...
const testimonials = [
	{
		quote: "Earlier I bought onions at ₹40, now I get them at ₹25. Saving ₹5000 per month.",
		name: "Raju Bhai",
		role: "Pav Bhaji Stall",
		city: "Mumbai",
	},
	{
		quote: "Daily fresh vegetables delivered. Customers are happy because taste improved.",
		name: "Sunita Devi",
		role: "Chaat Counter",
		city: "Delhi",
	},
	{
		quote: "Group orders give huge discounts on oil and spices. Business profit increased.",
		name: "Amit Sharma",
		role: "Dosa Stall",
		city: "Bangalore",
	},
	...
	<div className="bg-orange-50 min-h-screen w-full">
		...
		<section className="flex flex-col justify-center items-center min-h-[80vh] bg-gradient-to-br from-orange-50 to-yellow-100 text-center px-4">
			...
			<p className="text-xl text-gray-700 mb-10 max-w-2xl mx-auto leading-relaxed">
				Join other street food vendors to pool orders and unlock wholesale pricing.
				Get fresh vegetables, spices, and ingredients delivered daily to your stall.
			</p>
		...
		<section className="max-w-5xl mx-auto py-16 px-4">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center">
				{["Tell Your Needs", "Join Group", "Get Wholesale Rates", "Get Delivery"].map(
					(step, i) => (
		...
		<footer className="bg-gray-900 text-white py-12 mt-8">
			...
			<div className="text-center text-gray-400 text-base mt-12">
				© 2024 VendorMitra. All rights reserved.
			</div>
		</footer>
	</div>
);
